...
> preuves sur les données de santé), `how-it-starts` (la frise du parcours d'entrée).
> Elles restent récupérables dans l'historique git — commit `bf106bb` et antérieurs.
>
> La FAQ passe **après** le bandeau de clôture : le visiteur convaincu part sur le
> bouton, celui qui hésite trouve ses réponses juste en dessous.
